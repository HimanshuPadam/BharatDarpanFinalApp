...
class AdultPopulationActivity : AppCompatActivity() {
    private lateinit var entryRecyclerView: RecyclerView
    private var arrayList= arrayListOf<CensusEntry>()
    lateinit var binding: ActivityAdultPopulationBinding
    private lateinit var dbRef : DatabaseReference
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding= ActivityAdultPopulationBinding.inflate(layoutInflater)
    ...
    private fun getCensusEntry() {
        ...
        val query :Query = dbRef.orderByChild("age").startAt("18")
